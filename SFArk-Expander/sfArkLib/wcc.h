...
extern long	ReadInputFile(BYTE *Buf, long NumberOfBytesToRead);
extern long	WriteOutputFile(const BYTE *Buf, long NumberOfBytesToWrite);
extern bool	SetInputFilePosition(long NewPos);
extern bool	SetOutputFilePosition(long NewPos);
